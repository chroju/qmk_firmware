 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  KC_ESC,           KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                              KC_6,          KC_7,    KC_8,    KC_9,    KC_0,    LCTL(LALT(KC_DEL)), \
  KC_TAB,           KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                              KC_Y,          KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,            \
  KC_LSFT,          KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                              KC_H,          KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,            \
  TD(TD_CTL_GUI),   KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,          KC_LBRC,   KC_RBRC, KC_N,          KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,            \
                                     KC_LALT, KC_LGUI, LT(1, KC_F13), KC_SPC,    KC_ENT,  LT(2, KC_F16), KC_BSPC, KC_DEL  \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
void matrix_render_user(struct CharacterMatrix *matrix) {
  if (is_master) {
    ...
    /* matrix_write_ln(matrix, read_synopses()); */
